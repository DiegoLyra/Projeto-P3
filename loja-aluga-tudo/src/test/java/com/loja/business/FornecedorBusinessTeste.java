...
class FornecedorBusinessTeste {
    ...
    @Test
    void naoDeveAtualizarFornecedorComNomeInvalido() {
        Fornecedor fornecedor = criarFornecedor("1", " ");
    ...
    @Test
    void deveDeletarFornecedorSemHistorico() {
        Fornecedor fornecedor = criarFornecedor("1", "Fornecedor A");
        repository.salvar(fornecedor);
    ...
    @Test
    void naoDeveDeletarFornecedorComHistorico() {
        Fornecedor fornecedor = criarFornecedor("1", "Fornecedor A");
        ...
        assertEquals(
                "O fornecedor não pode ser excluído, tem histórico",
                exception.getMessage()
        );
